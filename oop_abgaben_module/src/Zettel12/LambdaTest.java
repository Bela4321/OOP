...
class LambdaTest {
    ...
    void removeIf() {
        ...
        ArrayList<Integer> testlist2 = new ArrayList<>(Arrays.asList(-1,-1,1,2135,-32,23,32,0,0,-12));
        Predicate<String> stringPredicate = x -> x.length() <= 4;
        Predicate<Integer> integerPredicate = x -> x<=0;

        List<String> expectedlist1 = Arrays.asList("servus", "stream");
        List<Integer> expectedlist2 = Arrays.asList(1,2135,23,32);
    ...
    void sortBy() {
        ...
        List<String> expectedstrlist = Arrays.asList("a", "!", "is","moin", "Moin","this","yes?","servus", "stream");
        List<Integer> expectedintlist = Arrays.asList(2135,23,-32,32,-12,-1,-1,1,0,0);
